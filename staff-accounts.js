...
(() => {
  ...
  function styles(){
    ...
    const s=document.createElement('style'); s.id='staffStyles'; s.textContent=`
      ...
      .staff-form{display:grid;gap:11px}.staff-form label{display:grid;gap:6px;font-size:12px;opacity:.88}.staff-form input,.staff-form select{box-sizing:border-box;width:100%;padding:12px;border-radius:12px;border:1px solid rgba(255,255,255,.12);background:#071426;color:#fff;outline:none}.staff-form input:focus,.staff-form select:focus{border-color:#58a6ff}.staff-btn{padding:11px 14px;border:0;border-radius:12px;background:#fff;color:#071426;font-weight:800;cursor:pointer}.staff-list{display:grid;gap:9px}.staff-row{display:flex;justify-content:space-between;gap:12px;align-items:center;padding:13px;border-radius:14px;background:rgba(255,255,255,.035);border:1px solid rgba(255,255,255,.07)}.staff-main b{display:block}.staff-main small{display:block;opacity:.62;margin-top:3px}.staff-actions{display:flex;gap:6px;flex-wrap:wrap}.staff-actions button{padding:8px 10px;border-radius:9px;border:1px solid rgba(255,255,255,.12);background:transparent;color:inherit;cursor:pointer}.staff-credential{margin-top:12px;padding:13px;border-radius:13px;background:rgba(88,166,255,.08);border:1px solid rgba(88,166,255,.18);font-size:13px}.staff-credential code{font-size:14px}.staff-note{font-size:12px;opacity:.62;line-height:1.5}.staff-empty{padding:16px;text-align:center;opacity:.55;border:1px dashed rgba(255,255,255,.12);border-radius:13px}
